...
function initializeUI() {
    const ids = [
        ...
        'deleteConfirmModal', 'astroForm', 'astroFormModalTitle', 'editingAstroOriginalName',
...
function openCreateAstroModal() {
    ...
    elements.editingAstroOriginalName.value = "";
...
function openEditAstroModal(planetName) {
    ...
    elements.editingAstroOriginalName.value = planetToEdit.name;
}
...
function showGenericMessageModal(message) {
    // CORREÇÃO: A referência ao modal genérico estava incorreta ('genericModal' em vez de 'genericMessageModal').
    elements.genericModalMessageText.textContent = message;
    elements.genericMessageModal.classList.remove('hidden');
    elements.genericMessageModal.classList.add('flex');
}
